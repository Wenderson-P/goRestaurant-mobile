...
const FoodDetails: React.FC = () => {
  ...
  useEffect(() => {
    async function loadFood(): Promise<void> {
      ...
      const favorite = favoriteResponse.data.find(
        findFavorite => findFavorite.id === response.data.id,
      );
      if (favorite) {
        setIsFavorite(true);
      }
  ...
  async function handleFinishOrder(): Promise<void> {
    try {
      ...
      Alert.alert(
        ...
        'Ocorreu um erro ao fazer o pedido,por favor, tente novamente mais tarde!',
      );
    }
  }
